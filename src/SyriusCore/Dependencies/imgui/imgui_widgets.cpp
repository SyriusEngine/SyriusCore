...
// For 32-bit and larger types, slider bounds are limited to half the natural usage range.
...
#include "../../../../include/SyriusCore/Dependencies/imgui/imstb_textedit.h"
...
void ImGui::ColorPickerOptionsPopup(const float* ref_col, ImGuiColorEditFlags flags)
{
    ...
    if (allow_opt_picker)
    {
        ...
        {
            // Draw small/thumbnail version of each picker usage (over an invisible button for selection)
