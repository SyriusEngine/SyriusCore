...
namespace Syrius {
    ...
    m_DeviceLimits(deviceLimits){
        SR_PRECONDITION(desc.size <= m_DeviceLimits->getMaxShaderStorageBufferSize(), "[ShaderStorageBuffer]: Supplied size {} exceeds device limit {}", desc.size, m_DeviceLimits->getMaxShaderStorageBufferSize());
