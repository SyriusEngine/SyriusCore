...
namespace Syrius{
    ...
    GLenum getGlBufferType(SR_BUFFER_USAGE type){
        switch (type){
            ...
            default: {
                SR_LOG_WARNING("GlUtils", "Invalid usage {} given to converter, return default: GL_DYNAMIC_DRAW", type);
    ...
    GLenum getGlDataType(SR_TYPE type){
        switch (type) {
            ...
            default: {
                SR_LOG_WARNING("GlUtils", "Invalid data type {} given to converter, return default: GL_FLOAT", type);
                return GL_FLOAT;
            }
        }
    }
    ...
    GLenum getGlShaderType(SR_SHADER_TYPE type){
        switch (type){
            ...
            default: {
                SR_LOG_WARNING("GlUtils", "Invalid shader type {} given to converter, return default: GL_VERTEX_SHADER", type);
    ...
    GLenum getGlDrawType(SR_DRAW_MODE type){
        switch(type){
            ...
            default: {
                SR_LOG_WARNING("GlUtils", "Invalid draw type {} given to converter, return default: GL_TRIANGLES", type);
                return GL_TRIANGLES;
            }
        }
    }
    ...
    GLenum getGlChannelFormat(SR_TEXTURE_FORMAT type){
        ...
        switch (channelCount) {
            ...
            default: {
                SR_LOG_WARNING("GlUtils", "Invalid channel type {} given to converter, return default: GL_RGBA", type);
                return GL_RGBA;
            }
        }
    }
    ...
    GLint getGlTextureFormat(SR_TEXTURE_FORMAT format){
        switch (format) {
            ...
            default: {
                SR_LOG_WARNING("GlUtils", "Invalid texture format {} given to converter, return default: GL_RGBA8", format);
                return GL_RGBA8UI;
            }
        }
    }
        ...
        switch (dataType) {
            ...
            case SR_INT8:
                switch (channelCount) {
                    ...
                    default: {
                        SR_LOG_WARNING("GlUtils", "Invalid texture format {} given to converter, defaulting to GL_RGBA8", format);
                        return GL_RGBA8;
                    }
                }
            case SR_UINT16:
            case SR_INT16:
                switch (channelCount) {
                    ...
                    default: {
                        SR_LOG_WARNING("GlUtils", "Invalid texture format {} given to converter, defaulting to GL_RGBA16", format);
                        return GL_RGBA16;
                    }
                }
            case SR_FLOAT32:
                switch (channelCount) {
                    ...
                    default: {
                        SR_LOG_WARNING("GlUtils", "Invalid texture format {} given to converter, defaulting to GL_RGBA32F", format);
                        return GL_RGBA32F;
                    }
                }
            default: {
    ...
    GLenum getGlTextureDataType(SR_TEXTURE_FORMAT format){
        ...
        switch (data) {
            ...
            case SR_FLOAT32:    return GL_FLOAT;
            default: {
                SR_LOG_WARNING("GlUtils", "Invalid texture format {} given to converter, defaulting to GL_UNSIGNED_BYTE", format);
    ...
    GLenum getGlComparisonFunc(SR_COMPARISON_FUNC func){
        switch (func){
            ...
            default: {
                SR_LOG_WARNING("GlUtils", "Invalid depth func {} given to converter, defaulting to GL_LESS", func);
                return GL_LESS;
            }
        }
    }
    ...
    GLint getGlTextureFilter(SR_TEXTURE_FILTER filter){
        switch (filter) {
            ...
            default: {
                SR_LOG_WARNING("GlUtils", "Invalid texture filter {} given to converter, defaulting to GL_LINEAR", filter);
                return GL_LINEAR;
            }
        }
    }
    ...
    GLint getGlTextureWrap(SR_TEXTURE_WRAP wrap){
        switch(wrap){
            ...
            default: {
                SR_LOG_WARNING("GlUtils", "Invalid texture wrap {} given to converter, defaulting to GL_REPEAT", wrap);
                return GL_REPEAT;
            }
        }
    }
    ...
    GLint getGlStencilFunc(SR_STENCIL_FUNC func){
        switch (func) {
            ...
            default: {
                SR_LOG_WARNING("GlUtils", "Invalid stencil function {} given to converter, defaulting to GL_KEEP", func);
                return GL_KEEP;
            }
        }
    }
